...
def main():
    ...
    parser.add_argument('--model_path', default=r'D:\openclaw\projects\Spongebob-pro\sft_768.pth', type=str, help="模型权重路径（.pth文件）")
    parser.add_argument('--tokenizer_path', default=r'D:\openclaw\projects\Spongebob-pro\tokenizer_15k', type=str, help="Tokenizer路径")
